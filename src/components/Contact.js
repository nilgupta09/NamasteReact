...
const Contact = () => {
    ...
    return   <section class="py-16 bg-gray-100 font-poppins dark:bg-gray-900">
        ...
        <div class="px-8 py-8 bg-white border rounded-md shadow-md dark:border-gray-800 dark:bg-gray-800">
            <form action="">
                ...
                <textarea rows="4" type="message" placeholder="Write a message..." required=""
                    onChange={(e) => setMessage(e.target.value)} class="block w-full px-4 mb-4 leading-tight text-gray-700 border rounded bg-gray-50 dark:placeholder-gray-400 py-7 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-700 "></textarea>
                <button
